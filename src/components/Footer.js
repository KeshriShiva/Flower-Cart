    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            <div className="footer-logo">
              ...
              <span className="footer-logo-text">FlowerCart</span>
            </div>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><a href="https://www.linkedin.com/in/shiva-keshri-b25a88276/" target="_blank" rel="noopener noreferrer">About Us</a></li>
          ...
          <div className="footer-section">
            ...
            <div className="contact-info">
              <p>📧 <a href="mailto:shivakeshri07@gmail.com">shivakeshri07@gmail.com</a></p>
            </div>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          ...
          <p>&copy; 2025 FlowerCart. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
